        ...
        <RecipeContainer key={singleRecipe._id}>
          {singleRecipe.recipe ? (
            <DescriptionImagesTagsDiv>
              <SmallDiv>
                <Link
                  to={`/users/${singleRecipe.userId}`}
                >{`${singleRecipe.username}, ${new Date(
              ...
              <Link to={`/recipes/${singleRecipe._id}`}>
                <ImageDiv>
                  ...
                  ) : singleRecipe.recipe.tags.includes('lunch') ? (
                    <img src={LUNCH} alt="Lunch" />
                  ) : singleRecipe.recipe.tags.includes('dinner') ? (
          ...
          <LikeContainer>
            {singleRecipe.userId === userId && (
              <button
                type="button"
                onClick={() => onDeleteClick(singleRecipe._id)}
